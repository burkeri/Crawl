<template>
  <div>
    ...
    <!-- Reviews -->
    <div id="container">
      <ul id="reviews" v-for="item in items" :key="item.key">
        <li>{{item.review}}</li>
      </ul>
    </div>
  </div>
...
export default {
  data() {
    return {
      ...
      name: "Lorem Ipsum",
      stars:
        "https://img.freepik.com/free-icon/five-points-star_318-1414.jpg?size=338&ext=jpg",
      items: [
        {
          key: 1,
          review:
  ...
  methods: {
    printRating: function() {
      ...
      for (var i = 0; i < iterator; i++) {
        ...
        lstar.setAttribute(
          "src",
          "/Users/richelleburke/Documents/UCF/UCF_Local/Group Projects/Project_2/Crawl/src/assets/left-star.png"
        );
